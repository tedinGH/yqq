        ...
        >
          <div class="item-left">
            <img
              ...
              class="avatar"
              v-headError
              v-if="(item.fromType == 0 || item.fromType == 2 ) && item.img"
            />
            <img
              ondragstart="return false"
              :src="global.fileDownUrl + 'compress/' + item.img"
          ...
          <div class="item-right" ondragstart="return false">
            ...
            <p class="name" v-html="item.name" :class="{verify: item.fromType==2}"></p>
            <img src="../assets/images/verify.png"  class="verify" v-if="item.fromType == 2 && item.paramId==1000150" style="margin-top: -12px;" />
            <img src="../assets/images/team.png"  class="verify" v-if="item.fromType == 2 && item.paramId==1000110" style="margin-top: -12px;" />
            <img src="../assets/images/service.png"  class="verify" v-if="item.paramId==1001446 || item.paramId==1014217" style="margin-top: -12px;" />
            <div class="setting">
        ...
        <section v-if="searchKey">
          ...
          >
            ...
            <div class="item-right" ondragstart="return false">
              ...
              <p class="name-bottom" v-if="!(item.isAlias && aliasKey)">
                <span v-if="item.alias">{{$t("msg.user.userName")}}:@<span v-keyWord="searchKey" v-html="item.alias"></span></span> 
              </p>
              <p class="name-bottom" v-if="item.isAlias && aliasKey">
          ...
          >
            <div class="item-left">
              ...
              class="avatar"
              v-headError
              v-if="(item.fromType == 0 || item.fromType == 2 ) && item.avatar"
            />
            <img
              ondragstart="return false"
              :src="global.fileDownUrl + 'compress/' + item.avatar"
              class="avatar"
              v-headErrors
              v-if="(item.fromType == 1) && item.avatar"
            />
              <img class="avatar" src="../assets/images/error-head.png" v-if="item.fromType == 0 && !item.avatar">
              <img class="avatar" src="../assets/images/error-head2.png"  v-if="item.fromType == 1 && !item.avatar">
            </div>
            <div class="item-right" ondragstart="return false">
          ...
          <div
            ...
            "
          >
            <img class="img" ondragstart="return false" src="../assets/images/search/datanone.png" />
    ...
    chatList() {
      ...
      if (!this.searchKey) {
        ...
        for (var i = 0; i < arr.length; i++) {
          ...
          if (m || (item.alias + "").indexOf(this.searchKey) >= 0) {
            list.push(item);
          }
    ...
    toFirst(){
      setTimeout(() => {
        if(this.tofirst){
          ...
          this.$set(this.topList[0], "isActivity", false);
          this.clickChat(this.topList[0])
          }else{
            this.$set(this.normalList[0], "isActivity", false);
            this.clickChat(this.normalList[0])
          }
        }
      }, 300);
    }
...
.search-record{
  ...
  i{
    ...
    width:46px;
    border-radius: 50%;
    background:$color-theme url(../assets/images/search/search.png) center no-repeat;
