  ...
  <div class="my-popup" v-if="showInvite">
    <div class="my-popup-content invite">
      ...
      <div class="display-flex group-info">
        <img
          class="img"
          v-if="inviteInfo.bodyContent.gAvatar"
        ...
        <!-- <span
          class="default"
          v-defaultHead
          v-if="!inviteInfo.bodyContent.gAvatar" v-html="inviteInfo.bodyContent.gName"
          ></span> -->
          <img class="img" src="../../assets/images/error-head2.png"  v-if="!inviteInfo.bodyContent.gAvatar">
      ...
      <p class="text2">{{ $t("msg.groupInvite.info1") }}</p>
      <p  class="text2">{{ $t("msg.groupInvite.info2") }}</p>
      <button
        type="button"
        class="btn"
