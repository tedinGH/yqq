...
export const LOGIN_STATE = Config.codeUrl + "/imrtcweb/login/state.htm"  //获取登录状态
export const QR_LOGIN = Config.codeUrl + "/imweb/user/qrcodelogin.htm" 
export const LOGIN_AGAIN = Config.imscUrl + '/api/scanLoginTipsApp.htm'  //点击确认登录  
export const CREATE_CODE = Config.baseUrl + '/imweb/user/createCode.htm'  // 获取点选验证码
export const CHECK_CODE = Config.baseUrl + '/imweb/user/checkCode.htm'  // 校验点选验证码
export const GET_SMS_CODE_NO = Config.baseUrl + '/imweb/msg/sms/noLoginSend.htm' 
export const LOGIN = Config.baseUrl + '/imweb/user/login.htm'
/*----- 好友模块 -----*/
...
export const FIND_USERMOBILE = Config.baseUrl + '/imscweb/api/findUserMobile.htm' //查询手机号
export const GET_FRIEND_INFO = Config.baseUrl + '/imscweb/friends/get.htm' //获取指定好友

export const ADD_CONTACTDI = Config.baseUrl + '/imscweb/contactDir/add.htm' //添加通讯录
export const ADD_FRIEND = Config.baseUrl + '/imscweb/friendsV2/add.htm' //添加好友
...
export const INVITE_GROUP_USER = Config.baseUrl + '/imscweb/group/inviteUserV2.htm' //邀请用户进群
export const INVITE_FORBID_USER = Config.baseUrl + '/imscweb/group/inviteForbidUser.htm' //邀请被禁止的用户进群
...
/*----- 其他 -----*/
export const UPDATE_ALLOWMOBILE = Config.baseUrl + '/imscweb/userPrivacy/set.htm' //修改用户是否允许通过手机号搜索
export const GET_ALLOWMOBILE = Config.baseUrl + '/imscweb/userPrivacy/getAll.htm' //查询用户是否允许通过手机号搜索
...
export const GET_FILE_SIZE = base.baseUrl +'/personal/getSystemConfig.htm'