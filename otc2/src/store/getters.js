...
export const forwardMenu= state => state.forwardMenu
...
export const friendcard = state => state.friendcard

export const isAllowMobile = state => state.isAllowMobile

export const filesize = state => state.filesize

export const deleteGroupmember = state => state.deleteGroupmember

export const records = state => state.records

export const tofirst = state => state.tofirst
