...
const filters = {
  ...
  timeFilter3(timestamp) {
    if (!timestamp) {
      return "1970-01-01 00:00";
    }
    // console.log(store.state.translate)
    let time = new Date(+timestamp);
    let str = "";
    let format = fmt => {
      const o = {
    ...
    str = format("yyyy-MM-dd ") + format("HH:mm:ss");
    return str;
  },
  ...
  fileFitler(value) {
    if (value) {
      ...
      else if (file == "zip" || file == "rar" || file == "arj" || file == "z") return "zip";
      else if (file == "txt") return "txt";
      else if (file == "mp3" || file == "wav" || file == "wma" || file == "aac" || file == "ogg") return "mp3";
      else if (file == "mp4" || file == "avi" || file == "mkv" || file == "rm" || file == "rmvb" || file == "flv" || file == "3gp" || file == "mtv")
        return "mp4";
