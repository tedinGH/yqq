...
export default {
  ...
  methods: {
    show() {
      ...
      canvasExt.drawRect("bg_canvas", "#45B4AA", this.getImg);
    },
    getImg(imgData) {
    ...
    transfer() {
      ...
      let obj = {};
      Util.getImgUrl(this.shotImg.src).then(
        data => {
          obj = {
            imgUrl: data,
...
.operation {
  ...
  .shot-icon {
    ...
    &.cancel {
      margin: 0 3px;
      background:  url(../../assets/images/icon/c2.png);
    }
    &.download {
      margin: 0 3px;
      background:  url(../../assets/images/icon/y.png);
    }
  }
  .line {
    display: inline-block;
