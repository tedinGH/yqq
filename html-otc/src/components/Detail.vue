      ...
      <div class="friend-info clearfix">
        <div class="friend-info-left">
          <div class="friend-avatar">
            ...
            <img class="avatar" src="../assets/images/error-head.png" v-if="!detail.headImg" v-headViewer>
        ...
        <div class="friend-info-right">
          ...
          <div class="friend-info-item" v-if="detail.alias">
            <span class="lable">{{$t("msg.user.userName")}}:</span>
        ...
        <ul class="group-members display-flex">
          ...
          >
            <img
              ...
              v-headError
            />
            <img class="avatar" src="../assets/images/error-head2.png" v-if="!item.headImg">
            <!-- <span
              class="default"
              v-defaultHead
              v-if="!item.headImg"
